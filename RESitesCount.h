...
void RESitesClass::InitialiseVars(void){
	...
	ifstream ifile("GATC.mm9.chr_offsets.txt");
	
	ifstream Mapptextbin("MM9.GATC.offsets.binary", ios::binary);
	...
	ifstream chrbounds("MM9.chrLengths.txt");
	int st, end;
...
ifstream file2 ("MM9.GATC.offsets.binary",ios::binary);
...
ifstream file ("MM9.GATCPos.bin", ios::in | ios::binary | ios::ate);
