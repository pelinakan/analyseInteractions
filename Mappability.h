...
void MappabilityClass::InitialiseVars(void){
	...
	ifstream ifile("/bubo/proj/b2011029/bin/Detect_Interactions/supportingFiles/Mappability.36mers.mm9.chr_offsets.txt");
	
	ifstream Mapptextbin("/bubo/proj/b2011029/bin/Detect_Interactions/supportingFiles/Mappability.36mers.offsets_mm9.binary", ios::binary);
...
ifstream file2 ("/bubo/proj/b2011029/bin/Detect_Interactions/supportingFiles/Mappability.36mers.offsets_mm9.binary",ios::binary);
...
ifstream file ("/bubo/proj/b2011029/bin/Detect_Interactions/supportingFiles/MM9.Mappability.36mer.bin", ios::in | ios::binary | ios::ate);
